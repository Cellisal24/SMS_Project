    ...
    <form action="{{ route('admin.exams.store') }}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="semester" class="form-control" placeholder="ឧ. ឆមាសទី១">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="academic_year" class="form-control" value="2026">
            </div>
        </div>
