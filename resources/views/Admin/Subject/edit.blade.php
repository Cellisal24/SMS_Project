...
<div class="subject-form-container">
    <div class="subject-form-header">
        <h1>ធ្វើបច្ចុប្បន្នភាពមុខវិជ្ជា</h1>
        <p class="subtitle">Edit subject information</p>
        <span class="subject-info-badge">ID: {{ $subject->subject_id }}</span>
    </div>
    ...
    <form action="{{ route('admin.subjects.update', $subject->subject_id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input 
                ...
                readonly
            >
            <span class="form-hint">ទិនន័យត្រូវបានកែវ (Cannot be changed)</span>
        </div>
        ...
        <div class="form-group">
            ...
            <input 
                ...
                placeholder="ឧទាហរណ៍៖ ដេលីវេរីវេរីកម្មវិធី"
                required
            >
            @error('subject_name')
        ...
        <div class="form-group">
            ...
            >
                ...
                <option value="Information Technology" {{ old('department', $subject->department) == 'Information Technology' ? 'selected' : '' }}>
                    Information Technology
                </option>
                <option value="Computer Science" {{ old('department', $subject->department) == 'Computer Science' ? 'selected' : '' }}>
                    Computer Science
                </option>
                <option value="Software Engineering" {{ old('department', $subject->department) == 'Software Engineering' ? 'selected' : '' }}>
                    Software Engineering
                </option>
                <option value="Data Science" {{ old('department', $subject->department) == 'Data Science' ? 'selected' : '' }}>
                    Data Science
                </option>
            </select>
            @error('department')
        ...
        <div class="btn-group-submit">
            ...
            <a href="{{ route('admin.subjects.index') }}" class="btn btn-secondary">ត្រឡប់ក្រោយ</a>
        </div>
    </form>
</div>
